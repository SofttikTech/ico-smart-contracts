...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    IERC20 public USDT; // USDT Address from which user needs to invest
     ...
     */
    function buyTokens(address beneficiary, uint256 amount) public payable nonReentrant {
    ...
    function _getTokenAmount(uint256 weiAmount)
        ...
        returns (uint256)
    {
        return weiAmount.mul(1000000000000000000).div(_rate);
    }
