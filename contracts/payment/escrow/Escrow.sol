...
contract Escrow is Secondary {
     ...
     */
    function deposit(uint256 weiAmount, address payee) public onlyPrimary payable {
     ...
     */
    function withdrawWithGas(address payable payee, IERC20 USDT) public onlyPrimary {
        uint256 payment = _deposits[payee];

        _deposits[payee] = 0;

        USDT.transfer(payee, payment);
